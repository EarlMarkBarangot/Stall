...
class Notification(dbase.Model):
    __tablename__ = 'notification'
    id = dbase.Column(dbase.Integer, primary_key=True, autoincrement=True)
    name = dbase.Column(dbase.String(60))
    tenant_id = dbase.Column(dbase.Integer)
    stall_id = dbase.Column(dbase.Integer)
    description = dbase.Column(dbase.String(60))
    seen = dbase.Column(dbase.Integer, nullable=False)
    status = dbase.Column(dbase.Integer, nullable=False)
    date = dbase.Column(dbase.DateTime)


    def __init__(self, name, description, date, tenant_id, stall_id):
        self.name = name
